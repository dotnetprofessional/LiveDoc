...
|-----------|----------|----------|
| Frontend / Viewer UI | Kaylee ⚛️ | React components, Tailwind styling, Zustand stores, viewer dashboard |
| Core Framework / Parser | Wash 🔧 | Gherkin parser, BDD DSL, Vitest reporter, schema definitions |
