...
- **Preferred:** auto
- **Rationale:** Use `claude-opus-4.8` for architecture and review reasoning, or `gpt-5.6-sol` for implementation and debugging reasoning. Lightweight models are only for mechanical work.
