...
feature(`Remove the root path from filenames to define a path`, (ctx) => {
    scenario(`Multiple Features are executed with various paths`, (ctx) => {
        ...
        """
        [
            "D:/dev/git.public/LiveDoc/packages/livedoc-vitest/_src/test/ReportingOutput/Feature1.Spec.js",
            "D:/dev/git.public/LiveDoc/packages/livedoc-vitest/_src/test/ReportingOutput/Feature3.Spec.js",
