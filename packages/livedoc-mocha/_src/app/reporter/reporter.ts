...
//     new LiveDocReporterX(runner);
// }
// exports = module.exports = livedoc;

// class LiveDocReporterX {
//     constructor (runner) {
//         Base.call(this, runner);

//         var features: model.Feature[] = [];
//         var suites: model.MochaSuite[] = [];
//         const _this = this;
...
//                         suites.push(bddContext.mochaSuite);
//                     }
//                     console.log("  " + bddContext.mochaSuite.title);
//                     break;
//             }
//         });
...
//     private formatSuite(type: string, suite: model.LiveDocSuite, indentSize: number) {
