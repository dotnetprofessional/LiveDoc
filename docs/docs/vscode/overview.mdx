...
{/* ![VS Code Snippet Expansion](/img/screenshots/vscode-snippet-expansion.png) */}
...
{/* ![Data Table Formatting](/img/screenshots/vscode-table-formatting.png) */}
...
{/* ![VS Code Viewer Panel](/img/screenshots/vscode-viewer-panel.png) */}
