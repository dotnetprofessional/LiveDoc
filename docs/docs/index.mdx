...
<img src={useBaseUrl('/img/logo-full.png')} alt="LiveDoc" className="hero-logo" />
...
<a className="sdk-card sdk-card--ts" href="/LiveDoc/reports/vitest/" target="_blank" rel="noopener">
...
<a className="sdk-card sdk-card--dotnet" href="/LiveDoc/reports/dotnet/" target="_blank" rel="noopener">
