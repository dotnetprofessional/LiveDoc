...
## Keep One Primary Given, When, and Then {#gherkin-structure}
...
LiveDoc reports repeated or missing Given/When/Then calls, untitled steps, and
And/But calls without a preceding primary step as non-fatal rule violations.
They appear in the Viewer without changing test pass/fail status.
