...
- **Next in this series**: [Reporting Model](./reporting-model.mdx) — the data structure that connects SDKs to the Viewer
- **Hands-on**: [Tutorial: Beautiful Tea](./tutorial-beautiful-tea.mdx) — build a complete living specification from scratch
