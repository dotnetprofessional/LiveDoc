...
graph LR
    ...
    V -->|"Protocol 3.0"| Viewer
    V -->|"Protocol 3.0"| VSCode
    X -->|"Protocol 3.0"| Viewer
    X -->|"Protocol 3.0"| VSCode
```
...
- **For contributors**: [REPORTER_MODEL_V3.md](https://github.com/dotnetprofessional/LiveDoc/blob/main/REPORTER_MODEL_V3.md) — full model specification and TypeScript interfaces
