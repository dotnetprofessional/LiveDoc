...
- **For contributors**: [REPORTER_MODEL_V3.md](https://github.com/nickvdyck/livedoc/blob/main/REPORTER_MODEL_V3.md) — full model specification and TypeScript interfaces
