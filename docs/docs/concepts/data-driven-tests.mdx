...
The examples below use the Gherkin/LiveDoc vocabulary to illustrate the concepts. Each SDK implements this using its own syntax — see the SDK links at the bottom for actual code.
:::
