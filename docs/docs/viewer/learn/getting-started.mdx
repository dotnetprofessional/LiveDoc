...
:::tip Fastest project setup: give your AI one URL
Tell your assistant:

**"Read https://livedoc.swedevtools.com/ai/setup.md and configure this
repository for LiveDoc, the Viewer, and full code coverage."**

No LiveDoc package or reusable skill needs to be installed first.
[AI project setup workflow](/guides/ai-project-setup)
:::
