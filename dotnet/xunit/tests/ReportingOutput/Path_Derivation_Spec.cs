...
public class Path_Derivation_Spec : SpecificationTest
{
    ...
    public void DerivePathFromNames_strips_leading_assembly_prefix()
    {
        var path = LiveDocTestRunReporter.DerivePathFromNames(
            "LiveDoc.xUnit.Tests.WritingFeatures.Scenario.Scenario_Outline_Spec",
            "LiveDoc.xUnit.Tests");

        Assert.Equal("WritingFeatures/Scenario/Scenario_Outline_Spec.cs", path);
    }
    ...
    {
        var path = LiveDocTestRunReporter.DerivePathFromNames(
            "SweDevTools.LiveDoc.xUnit.Tests.WritingFeatures.Scenario.Scenario_Outline_Spec",
            "LiveDoc.xUnit.Tests");
